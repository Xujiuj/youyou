      ...
      <div className="gallery-ending-content">
        <div ref={letterRef} className="gallery-ending-letter">
          ...
          <div className="gallery-ending-text">
            <p>你好，优优：</p>
            <p>容我先做个自我介绍吧，我叫许久（这是真名，虽然听着像假的），理工科，一个普普通通的没毕业多久的大学生。</p>
            <p>偶然一次刷到你，当时看到了你身上散发出的微光，但我等理工男，如此理智的男生，怎么可以胡来，于是我压住心里的激动，继续我扫地僧的生活。</p>
            <p>然而过了两天，加完班后我再次刷到你了，这对一个不常用抖音不刷女主播的人来说可不对劲，在过去的六个月里，我算了两次塔罗牌，结果都告诉我有一个人会在年初出现，难道玄学真的管用？</p>
            <p>于是，我暗暗许下了连续其次打开抖音可以看到你的愿望，这七次，我都在直播间外看着你，我发现了，你与其他主播并不相同。</p>
            <p>就如我前面所说，只有善良、纯真的女孩子眼里才会有闪动的微光，外面的世界纷扰凌乱，网络更甚，我想要护住这一束光。</p>
            <p>在某一天，你告诉我，你要和我说明白，你做好了失去我的准备，但我听完之后，我就知道，我没有看错人，这更加坚定了我的信念。</p>
            <p>你真是笨，当时还在直播呢，这大庭广众的多不好，我还从没在大庭广众之下表过白哄过人呢，现在想想感觉这都不像是我。</p>
            <p>这段时间你也确实给我带来了快乐，我这张扑克脸都压不住嘴角了，其实我觉得带着滤镜看你挺不错的，至少这样就不会把外界乱七八糟的东西带进来了，谢谢你的出现。</p>
            <p>其实我想说的还是，希望你可以像个小朋友少一些烦恼，做一个快乐的女孩子，可以做自己想做的事情，也可以拒绝自己不愿意做的事情。</p>
            <p>在这个过程中，我也会尽自己的一切努力，把你的想象变成现实，我超级行动派的(拿嘴巴换的)，放心！只要你想，我就会让它实现。</p>
            <p>最后，可以不用以工作的态度对我呀，能否让我认识一下真实的你呢？</p>
            <p className="gallery-ending-signature">—— 你的超级粉丝</p>
          </div>
        </div>
      </div>
    </div>
